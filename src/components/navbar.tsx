...
const Navbar: React.FC<{ isOpen: boolean; toggleMenu: () => void }> = ({
  isOpen,
  toggleMenu,
}) => {
  return (
    <nav className='bg-slate-100 dark:bg-gray-900 shadow'>
      ...
      {/* ${isOpen ? 'block' : 'hidden'} */}
      <div
        className={`md:hidden transition-all duration-200 fixed w-full z-10 ${
